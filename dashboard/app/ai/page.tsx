...
export default function AiPage() {
  ...
  return <ConsolePage><PageIntro eyebrow="AI" title="AI" description="AI call volume, latency, failures, tokens, estimated cost, and exact meal-call traces."><div className="flex flex-wrap items-center gap-2"><RangeControl value={range} onChange={setRange} label="Window" options={["7d", "30d", "90d"]} /><RefreshButton refreshing={bundle.refreshing || requests.refreshing} onClick={() => { bundle.refresh(); requests.refresh(); }} /></div></PageIntro><div className="mt-3 grid gap-3"><MetricRibbon items={[
